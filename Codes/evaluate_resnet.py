...
MODEL_NAME = 'resnet_encoderearlyfusion-nobndepth_decoder_resnet18_varspatialdrop_3hotdc_splitker5_dc80_16Rorigdataorignormaliz_biased_crossentropy_auxlabelsgt2dc_annotated'
LOGDIR = './log_dir/'
DATAFORMAT = 'NHWC'
